        ...
        <footer className="font-sans tracking-wide bg-teal-950 container py-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10">
                ...
                <div>
                    ...
                    <ul className="space-y-5 mt-6 max-sm:hidden">
                        <li>
                            <a href="#" className="hover:text-white text-gray-300 text-sm">Must Haves</a>
                        </li>
                        <li>
                            <a href="#" className="hover:text-white text-gray-300 text-sm">Elderly Care</a>
                        </li>
                        <li>
                            <a href="#" className="hover:text-white text-gray-300 text-sm">Personal Care</a>
                        </li>
                        <li>
                            <a href="#" className="hover:text-white text-gray-300 text-sm">Healthcare Devices</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-5 mt-6 max-sm:hidden">
                        ...
                        <li>
                            <a href="#"
                               className="hover:text-white text-gray-300 text-sm">Portfolio</a>
                        </li>
                        <li>
            ...
            <div className="flex flex-wrap max-md:flex-col gap-4">
                <ul className="md:flex md:space-x-6 max-md:space-y-2">
                    <li>
                        <a href="#" className="hover:text-white text-gray-300 text-sm">Terms of
                            Service</a>
                    </li>
                    <li>
                        <a href="#" className="hover:text-white text-gray-300 text-sm">Privacy
                            Policy</a>
                    </li>
                    <li>
